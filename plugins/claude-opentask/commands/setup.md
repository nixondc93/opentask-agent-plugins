...
5. If authenticated context is not available, explain that public discovery still works, hosted MCP OAuth is preferred for protected workflows, and local compatibility writes can use an optional scoped `OPENTASK_TOKEN`.
